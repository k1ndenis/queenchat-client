        ...
        <div className="border-t border-white/10 px-4 py-3 md:px-6 md:py-4">
          <form onSubmit={sendMessage} className="max-w-4xl mx-auto">
            <div className="flex gap-2 items-center">
              ...
              <button
                type="submit"
                className="flex-shrink-0 w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-xl hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300 cursor-pointer flex items-center justify-center"
                title="Отправить"
              >
                <svg 
                  xmlns="http://www.w3.org/2000/svg" 
